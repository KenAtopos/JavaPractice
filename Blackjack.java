...
public class Blackjack {
    ...
    public static void main(String[] args) {
        ...
        String faceDownCard2 = faceDown();
        int totalDealerNum = dealerNum1 + dealerNum2;
        ...
        while (true) {
            ...
            if (choice.equals("hit")) {
                int num = drawRandomCard();
                String card = cardString(num);
                totalNum += num;
                System.out.println("\nYou get a \n" + card);
                System.out.println("\nYou new total is " + totalNum);
                if (totalNum > 21) {
                ...
                while (true) {
                    if (totalDealerNum <= 17) {
                        int dealerNum = drawRandomCard();
                        String dealerCard = cardString(dealerNum);
                        totalDealerNum += dealerNum;
                        System.out.println("Dealer gets a \n" + dealerCard);
                        System.out.println("Dealer's total number is " + totalDealerNum);
                    } else {
                        if (totalDealerNum > 21) {
                            System.out.println("Bust! Dealer loses");
                        } else {
                            System.out.println("Dealer's total number is " + totalDealerNum);
                            if (totalNum > totalDealerNum) {
                                System.out.println("You win!");
                            } else if (totalNum == totalDealerNum) {
    ...
    public static String hitOrStay() {
        ...
        while (true) {
            ...
            if (option.equals("hit") || option.equals("stay")) {
                ...
                System.out.println("Please try again, write 'hit' or 'stay' ");
                continue;
            }
        }
    }
